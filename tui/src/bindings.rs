...
pub use module_bindings::{
    DeviceMetric, DeviceMetricSample, DeviceMetricsReport, ack_ui_command, create_api_key,
    create_folder, delete_device, delete_file, delete_secret, delete_ssh_endpoint, delete_ssh_key,
    register_device, rename_device, rename_file, report_device_metrics, reveal_secret,
    reveal_ssh_key, revoke_api_key, send_ui_event, set_device_hostname,
    set_device_metrics_retention, set_secret, set_secret_devices, set_secret_permissions,
...
pub use module_bindings::{
    ...
    MySecretsTableAccess, MySshEndpointsTableAccess, MySshKeysTableAccess, MyUiCommandsTableAccess,
    MyUserTableAccess, UiEventTableAccess,
};
