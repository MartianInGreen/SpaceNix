...
pub struct UserCols {
    ...
    pub display_name: __sdk::__query_builder::Col<User, Option<String>>,
    pub role: __sdk::__query_builder::Col<User, String>,
    pub created_at: __sdk::__query_builder::Col<User, __sdk::Timestamp>,
    pub last_login_at: __sdk::__query_builder::Col<User, __sdk::Timestamp>,
}
